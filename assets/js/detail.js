...
if (bien) {
    ...
    // --- NOUVEAU : GESTION DU GARAGE ---
    const elGarage = document.getElementById('detail-garage');
    if(elGarage) {
        // Si on a précisé un garage dans datas.js, on l'affiche, sinon on met un tiret
        elGarage.innerText = bien.garage || "-"; 
    }
    ...
    // --- B. GESTION DES CARACTÉRISTIQUES (La boucle) ---
